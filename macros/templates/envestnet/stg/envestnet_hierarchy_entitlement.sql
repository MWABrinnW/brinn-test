{%- macro envestnet_hierarchy_entitlement(src) -%}
select
    ...
    , nullif(split_part(content , '|' , 3), '')::int           as owner_id
    , nullif(split_part(content , '|' , 4), '')::varchar(50)   as entitlement
    , nullif(split_part(content , '|' , 5), '')::varchar(8000) as entitlement_value
