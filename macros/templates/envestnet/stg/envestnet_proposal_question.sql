{%- macro envestnet_proposal_question(src) -%}
select
    ...
    , nullif(split_part(content , '|' , 3), '')::int           as question_id
    , nullif(split_part(content , '|' , 4), '')::varchar(2048) as short_question
    , nullif(split_part(content , '|' , 5), '')::varchar(128)  as answer
