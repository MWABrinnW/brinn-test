{%- macro envestnet_proposal_proposed_investment_group(src) -%}
select
    ...
    , nullif(split_part(content , '|' , 3), '')::int           as proposed_investment_group_id
    , nullif(split_part(content , '|' , 4), '')::varchar(30)   as risk_tolerance
    , nullif(split_part(content , '|' , 5), '')::varchar(30)   as investment
