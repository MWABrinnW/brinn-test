{%- macro fidelity_raw_nabase_102_person(src) -%}
select
  ...
  , nullif(trim(substring(content, 187, 4)), '')::int                                     as FFR_NAME_COUNT
  ...
  , nullif(trim(substring(content, 193, 12)), '')                                         as FIXED_FORMAT_FIRST_NAME_1
  , nullif(trim(substring(content, 205, 10)), '')                                         as FIXED_FORMAT_MIDDLE_NAME_1
  , nullif(trim(substring(content, 215, 25)), '')                                         as FIXED_FORMAT_LAST_NAME_1
  , nullif(trim(substring(content, 240, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_PREFIX_1
  , nullif(trim(substring(content, 250, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_SUFFIX_1
  , nullif(trim(substring(content, 260, 8)), '')                                          as FIXED_FORMAT_DATE_OF_BIRTH_1
  , nullif(trim(substring(content, 268, 8)), '')                                          as FFR_DATE_OF_DEATH_1
  ...
  , nullif(trim(substring(content, 309, 12)), '')                                         as FIXED_FORMAT_FIRST_NAME_2
  , nullif(trim(substring(content, 321, 10)), '')                                         as FIXED_FORMAT_MIDDLE_NAME_2
  , nullif(trim(substring(content, 331, 25)), '')                                         as FIXED_FORMAT_LAST_NAME_2
  , nullif(trim(substring(content, 356, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_PREFIX_2
  , nullif(trim(substring(content, 366, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_SUFFIX_2
  , nullif(trim(substring(content, 376, 8)), '')                                          as FIXED_FORMAT_DATE_OF_BIRTH_2
  , nullif(trim(substring(content, 384, 8)), '')                                          as FFR_DATE_OF_DEATH_2
  ...
  , nullif(trim(substring(content, 425, 12)), '')                                         as FIXED_FORMAT_FIRST_NAME_3
  , nullif(trim(substring(content, 437, 10)), '')                                         as FIXED_FORMAT_MIDDLE_NAME_3
  , nullif(trim(substring(content, 447, 25)), '')                                         as FIXED_FORMAT_LAST_NAME_3
  , nullif(trim(substring(content, 472, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_PREFIX_3
  , nullif(trim(substring(content, 482, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_SUFFIX_3
  , nullif(trim(substring(content, 492, 8)), '')                                          as FIXED_FORMAT_DATE_OF_BIRTH_3
  , nullif(trim(substring(content, 500, 8)), '')                                          as FFR_DATE_OF_DEATH_3
