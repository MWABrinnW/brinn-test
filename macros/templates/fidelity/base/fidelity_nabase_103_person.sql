{%- macro fidelity_nabase_103_person(src) -%}
select
    ACCOUNT_CUSTODIAL
  ...
  , FIXED_FORMAT_FIRST_NAME_3                                             as FIXED_FORMAT_FIRST_NAME_3
  , FIXED_FORMAT_MIDDLE_NAME_3                                            as FIXED_FORMAT_MIDDLE_NAME_3
  , FIXED_FORMAT_LAST_NAME_3                                              as FIXED_FORMAT_LAST_NAME_3
  , FIXED_FORMAT_NAME_TITLE_PREFIX_3                                      as FIXED_FORMAT_NAME_TITLE_PREFIX_3
  , FIXED_FORMAT_NAME_TITLE_SUFFIX_3                                      as FIXED_FORMAT_NAME_TITLE_SUFFIX_3
  , case
        when nvl(FIXED_FORMAT_DATE_OF_BIRTH_3, '') in ('', '0000', '000000', '00000000') then null::date
        else to_date(FIXED_FORMAT_DATE_OF_BIRTH_3, 'YYYYMMDD') end::date  as FIXED_FORMAT_DATE_OF_BIRTH_3
  , case
        when nvl(FFR_DATE_OF_DEATH_3, '') in ('', '0000', '000000', '00000000') then null::date
        else to_date(FFR_DATE_OF_DEATH_3, 'YYYYMMDD') end::date           as FFR_DATE_OF_DEATH_3
  ...
  , _source_file
from {{ ref('fidelity_' ~ src ~ '_history__vw_raw_nabase_103_person') }}
{%- endmacro -%}