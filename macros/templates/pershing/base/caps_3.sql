...
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 18, 6)), '000000'), '')) / power(10, 03)::number as investment_professional_split_percent
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 24, 13)), '0000000000000'), '')) / power(10, 02)::number as total_amount_of_revenue_generated_by_the_transaction
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 37, 11)), '00000000000'), '')) / power(10, 02)::number as pershing_charge
...
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 57, 13)), '0000000000000'), '')) / power(10, 02)::number as total_order_commission
...
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 74, 13)), '0000000000000'), '')) / power(10, 02)::number as principal
...
, {{target.database}}.{{target.schema}}.signed_to_numeric(nullif(nullif(trim(substring(content, 121, 13)), '0000000000000'), '')) / power(10, 02)::number as service_chargeother_fee
