{%- macro gtol_g_mutual_fund_product_type_order_information(src) -%}
...
, trim(nullif(substring(content, 217, 1), '0'))::varchar(1) as product_identifier_for_record_g
, trim(nullif(substring(content, 218, 1), '0'))::varchar(1) as cdsc_waiver_reason_type_code
, to_number(nullif(nullif(trim(substring(content, 219, 18)), '000000000000000000'), '')) / power(10, 02)::number as loi_amount
, trim(nullif(substring(content, 237, 1), '0'))::varchar(1) as loiroa_code
, to_number(nullif(nullif(trim(substring(content, 238, 18)), '000000000000000000'), '')) / power(10, 02)::number as roa_amount
, trim(nullif(substring(content, 256, 1), '0'))::varchar(1) as nav_net_asset_value_status_code
-- , trim(nullif(substring(content, 257, 410), ''))::varchar(410) as not_used_2
...
, to_number(nullif(nullif(trim(substring(content, 789, 18)), '000000000000000000'), '')) / power(10, 05)::number as leaves_quantity
, trim(nullif(substring(content, 807, 1), '0'))::varchar(1) as leaves_quantity_sign_values_include
...
, try_to_time(nullif(substring(content, 916, 12), '000000000000'), 'HH24MISSFF6')::time as pershing_order_receipt_time_in_hhmissnnnnnn_format
