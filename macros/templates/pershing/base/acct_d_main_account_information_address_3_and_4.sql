{%- macro acct_d_main_account_information_address_3_and_4(src) -%}
...
, trim(nullif(substring(content, 41, 1), '0'))::varchar(1) as address_3_transaction_code
, trim(nullif(substring(content, 42, 1), '0'))::varchar(1) as special_handling_indicator_3
, trim(nullif(substring(content, 43, 1), '0'))::varchar(1) as delivery_identifier_3
, trim(nullif(substring(content, 44, 4), '0000'))::varchar(4) as attention_line_prefix_3
, trim(nullif(substring(content, 48, 28), '0000000000000000000000000000'))::varchar(28) as attention_line_detail_3
, trim(nullif(substring(content, 76, 32), '00000000000000000000000000000000'))::varchar(32) as address_3_line_1
, trim(nullif(substring(content, 108, 32), '00000000000000000000000000000000'))::varchar(32) as address_3_line_2
, trim(nullif(substring(content, 140, 32), '00000000000000000000000000000000'))::varchar(32) as address_3_line_3
, trim(nullif(substring(content, 172, 32), '00000000000000000000000000000000'))::varchar(32) as address_3_line_4
...
, trim(nullif(substring(content, 236, 2), '00'))::varchar(2) as country_code_3
, trim(nullif(substring(content, 238, 1), '0'))::varchar(1) as set_as_mailing_address_indicator_3
...
, trim(nullif(substring(content, 338, 1), '0'))::varchar(1) as address_4_transaction_code
, trim(nullif(substring(content, 339, 1), '0'))::varchar(1) as special_handling_indicator_4
, trim(nullif(substring(content, 340, 1), '0'))::varchar(1) as delivery_identifier_4
, trim(nullif(substring(content, 341, 4), '0000'))::varchar(4) as attention_line_prefix_4
, trim(nullif(substring(content, 345, 28), '0000000000000000000000000000'))::varchar(28) as attention_line_detail_4
, trim(nullif(substring(content, 373, 32), '00000000000000000000000000000000'))::varchar(32) as address_4_line_1
, trim(nullif(substring(content, 405, 32), '00000000000000000000000000000000'))::varchar(32) as address_4_line_2
, trim(nullif(substring(content, 437, 32), '00000000000000000000000000000000'))::varchar(32) as address_4_line_3
, trim(nullif(substring(content, 469, 32), '00000000000000000000000000000000'))::varchar(32) as address_4_line_4
...
, trim(nullif(substring(content, 533, 2), '00'))::varchar(2) as country_code_4
, trim(nullif(substring(content, 535, 1), '0'))::varchar(1) as set_as_mailing_address_indicator_4
