...
with cte_baystate_fee_schedule as (
    select
        account_id
        , effective_date
...
select
    ...
    , a.account_registration_type::text(500)                              as pms_account_type
    , case
    ...
    end::text(500)                                                        as pms_location_code
    {% if instance | lower == 'baystate' %}
    ...
    , case when a.system_key = 'black_diamond__baystate' then a.style_name
        else null end::text(500)                                          as pms_model_investment_strategy
    ...
    {% if instance == 'uhnw' %}
       ,  case
        ...
        else pms_account_number end::varchar(500)                         as __account_key
    {% else %}
       , pms_account_number::varchar(500)                                 as __account_key
    {% endif %}
