{%- macro black_diamond_portfolio_groups(src, instance, firm_source, extra_columns=none, extra_joins=none) -%}
...
select
    ...
    , a.json:PortfolioGroupName::string            as portfolio_group_name
