...
select
  ...
  , nullif(trim(substring(content, 193, 50)), '')                                         as FIXED_FORMAT_MIDDLE_NAME_1
  , nullif(trim(substring(content, 205, 10)), '')                                         as FIXED_FORMAT_LAST_NAME_1
  , nullif(trim(substring(content, 215, 25)), '')                                         as FIXED_FORMAT_NAME_TITLE_PREFIX_1
  , nullif(trim(substring(content, 240, 10)), '')                                         as FIXED_FORMAT_NAME_TITLE_SUFFIX_1
