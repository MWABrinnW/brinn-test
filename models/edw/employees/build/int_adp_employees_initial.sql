select
    ...
    , w.eeo_identification_method
        as associate_eeo_identification_method
    ...
    , parse_json(w.home_organizational_units)[0]:nameCode:codeValue::varchar(100)
        as home_organizational_units_market_code
    , parse_json(w.home_organizational_units)[0]:nameCode:longName::varchar(100)
        as home_organizational_units_market_name_1
    , parse_json(w.home_organizational_units)[0]:nameCode:shortName::varchar(100)
        as home_organizational_units_market_name_2
    , parse_json(w.home_organizational_units)[1]:nameCode:codeValue::varchar(100)
        as home_organizational_units_department_code
    , parse_json(w.home_organizational_units)[1]:nameCode:longName::varchar(100)
        as home_organizational_units_department_name_1
    , parse_json(w.home_organizational_units)[1]:nameCode:shortName::varchar(100)
        as home_organizational_units_department_name_2
    ...
    , parse_json(occupational_classifications)[0]:classificationCode:codeValue::varchar(100)
        as occupational_classifications_eeo_code
    , parse_json(occupational_classifications)[0]:classificationCode:longName::varchar(100)
        as occupational_classifications_eeo_class_p2
    , parse_json(occupational_classifications)[0]:classificationCode:shortName::varchar(100)
        as occupational_classifications_eeo_class_p1
    , parse_json(occupational_classifications)[1]:classificationCode:codeValue::varchar(100)
        as occupational_classifications_class_code
    ...
    , coalesce(
        home_organizational_units_department_name_1
        , home_organizational_units_department_name_2
    )                                                                                        as position_department_name
    , coalesce(
        home_organizational_units_market_name_1
        , home_organizational_units_market_name_2
    )                                                                                        as position_market_name
...
from {{ ref('adp_history__workers') }} as w
left join {{ ref('adp_status_change_reasons') }} as sc
