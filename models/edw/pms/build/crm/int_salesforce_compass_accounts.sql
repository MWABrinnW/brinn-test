select
    ...
    , ei.location_c                                             as location--noqa: RF04
    ...
    , contact.name                                              as owner--noqa: RF04
...
left join {{ ref('salesforce_compass__base_model_c') }} as model--noqa: RF04
