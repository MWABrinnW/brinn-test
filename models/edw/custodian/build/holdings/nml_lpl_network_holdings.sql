select
  ...
  , coalesce(s.symbol, p.cusip)::varchar(100) as symbol
  , s.symbol::varchar(100)                    as ticker
  , p.cusip::varchar(100)                     as cusip
  , s.security_description::varchar(100)      as security_name_source
  ...
  , p.security_id::varchar(100)               as security_id_source
  ...
  , s.security_type_code::varchar(100)        as product_type_source_code

  , null::varchar(100)                        as account_type
  , null::varchar(100)                        as account_type_source
  , null::varchar(100)                        as account_type_source_code
