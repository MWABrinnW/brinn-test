select
    a.effective_date
    , 'tda'                          as custodian
    , 'mwa'::varchar(500)            as firm
    , 'mwa'::varchar(500)            as firm_source
    ...
    , null::varchar(500)             as account_type-- (ira rollover, etc)
    , null::varchar(500)             as account_type_source_definition
    , a.account_type::varchar(500)   as account_type_source_code
    , null::date                     as opened_date

    , a.account_type::varchar(500)   as account_title
    , a.first_name::varchar(500)     as first_name
    , null::varchar(500)             as middle_name-- not provided
    ...
    , null::varchar(500)             as cost_basis_method_mutual_funds-- not available
    , null::varchar(500)             as cost_basis_method_non_mutual_funds-- not available
    , case
    ...
    , a.city::varchar(500)           as mailing_address_city
    , a.state::varchar(500)          as mailing_address_state
    , a.zip_code::varchar(12)        as mailing_address_zip
    , null::varchar(500)             as mailing_address_country
