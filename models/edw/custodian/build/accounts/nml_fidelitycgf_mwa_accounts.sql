select a.effective_date       as effective_date
     ...
     , case
           when address_line_3 is not null then concat_ws(', ', a.address_line_1, a.address_line_2, a.address_line_3)
           when address_line_2 is not null then concat_ws(', ', a.address_line_1, a.address_line_2)
           when address_line_1 is not null then a.address_line_1
     ...
     , {{ col_is_head(reference=ref('fidelity_mwa_history__vw_cgf_acct'), source_date_col='effective_date') }}
     , {{ col_is_current(date_col='effective_date') }}
     , _source_loaded_at      as _created_at
     , _source_loaded_at      as _source_loaded_at
     , _source_file           as _source_file
from {{ ref('fidelity_mwa_history__vw_cgf_acct') }} a
