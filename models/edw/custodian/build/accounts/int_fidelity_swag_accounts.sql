-- depends_on: {{ source('fidelity_swag', 'nabase') }}
-- depends_on: {{ ref('fidelity_swag_history__vw_nabase_2x1_mailing_address') }}
-- depends_on: {{ ref('fidelity_swag_history__vw_nabase_2x2_legal_address') }}
-- depends_on: {{ ref('fidelity_swag_history__vw_nabase_3x0_notification') }}
-- depends_on: {{ ref('fidelity_swag_history__vw_nabase_2x0_customer') }}
-- depends_on: {{ ref('fidelity_swag_history__vw_nabase_101_account') }}
...
{%- set src = source('fidelity_swag', 'nabase') -%}
...
(
  select
    ...
    ,country_name
  from {{ ref('fidelity_swag_history__vw_nabase_2x1_mailing_address') }}
  where true
...
(
  select
    ...
    ,fixed_format_postal_code
    ,country_name
  from {{ ref('fidelity_swag_history__vw_nabase_2x2_legal_address') }}
  where true
...
(
  select
    ...
    ,account_custodial
    ,email_address
  from {{ ref('fidelity_swag_history__vw_nabase_3x0_notification') }}
  where true
...
(
  select
    ...
    ,telephone_number_1
  from {{ ref('fidelity_swag_history__vw_nabase_2x0_customer') }}
  where true
...
select
  ...
  , {{ col_is_head(
      reference=ref('fidelity_swag_history__vw_nabase_101_account'),
