select
    ...
    , a.legal_address_city::varchar(75)                as legal_address_city
    , a.legal_address_state::varchar(50)               as legal_address_state
    , a.legal_address_zip::varchar(12)                 as legal_address_zip
    , a.legal_address_country::varchar(50)             as legal_address_country
