select
    ...
    , t.transaction_source_code::text(500)             as transaction_type_1_source_code
    , t.transaction_type_code::text(500)               as transaction_type_2_source_code
    , t.transaction_sub_type_code::text(500)           as transaction_type_3_source_code
    , t.transaction_source_code_description::text(500) as transaction_type_4_source_code
    ...
    , t.isin                                           as isin
    , t.sedol                                          as sedol
    , null::text(500)                                  as transaction_id_source
    , null::text(500)                                  as transaction_id
    , t.is_head                                        as is_head
    , t.is_current                                     as is_current
    , t._source_loaded_at                              as _source_loaded_at
    , t._source_file                                   as _source_file
from {{ ref('schwab__base_transactions') }} as t
left join
    {{ ref('bld_custodian_accounts') }} as a
    on
