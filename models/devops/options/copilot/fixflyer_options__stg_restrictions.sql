...
select
    to_date(a.json:restrictionStartDate::text(200), 'YYYYMMDD')
    ...
    , a.json:extRestriction::text(200)
        as external_restriction
    , a.json:restrictionMapping::text(200)
        as restriction_mapping
...
from {{ source('copilot', 'restrictions') }} as a
