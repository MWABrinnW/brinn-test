with cte_flyer as (
    ...
    from {{ ref('fixflyer_options__stg_sod_accounts_history') }}
    where is_head_for_day = 1 and custodian ilike 'fidelity'
    group by 1 , 2
)
, cte_allocations as (
    ...
    from {{ ref('fixflyer_options__stg_orders_allocations') }}
    group by 1,2
)
