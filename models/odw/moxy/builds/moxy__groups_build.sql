...
select 
    ...
    , null::text        as "Closing Method"
    , null::text        as "Settle Currency"
    , null::text        as "Account Status"
    , null::text        as "Account Type"
    , null::text        as "Is Taxable"
    , null::text        as "Investment Goal"
    , null::text        as "Cash Buffer"
    , null::text        as "Cash Buffer Pct."
