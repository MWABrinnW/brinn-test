with cte_union as (
    select
        ...
        , system_instance::varchar(200)                  as system_instance
        , system_key::varchar(200)                       as system_key
        , location_code::varchar(200)                    as location_code
        , office_name::varchar(200)                      as office_name
        , client_location_code::varchar(200)             as client_location_code
        , client_office_name::varchar(200)               as client_office_name
        ...
        , invoice_number_source::varchar(200)            as invoice_number_source
        , billing_statement_id_source::varchar(200)      as billing_statement_id_source
        , billing_statement_id_crm::varchar(200)         as billing_statement_id_crm
        , invoice_status::varchar(600)                   as invoice_status
        , is_intra_period_invoice::number(38 , 0)        as is_intra_period_invoice
        , account_number::varchar(200)                   as account_number
        , account_number_formatted::varchar(200)         as account_number_formatted
        , billing_account_number::varchar(200)           as billing_account_number
        , account_id_pms::varchar(200)                   as account_id_pms
        , registrant_name::varchar(200)                  as registrant_name
        , account_name::varchar(200)                     as account_name
        , type_of_account::varchar(200)                  as type_of_account
        , client_id_pms::varchar(200)                    as client_id_pms
        ...
        , model_grouping_assignment::varchar(200)        as model_grouping_assignment
        , custodian::varchar(200)                        as custodian
        , billing_custodian::varchar(200)                as billing_custodian
        , partner_firm::varchar(200)                     as partner_firm
        , partner_firm_original::varchar(200)            as partner_firm_original
        , client_manager_source::varchar(200)            as client_manager_source
        , client_manager_original::varchar(200)          as client_manager_original
        , associate_id_original::varchar(200)            as associate_id_original
        , client_manager_primary::varchar(200)           as client_manager_primary
        , associate_id_primary::varchar(200)             as associate_id_primary
        , client_manager_type::varchar(200)              as client_manager_type
        , client_manager::varchar(200)                   as client_manager
        ...
        , billing_frequency::varchar(600)                as billing_frequency
        , billing_method::varchar(600)                   as billing_method
        , bill_on_balance_type::varchar(600)             as bill_on_balance_type
        , payment_terms::varchar(600)                    as payment_terms
        , payment_method_fee::varchar(200)               as payment_method_fee
        , account_class::varchar(200)                    as account_class
        , recurring_revenue::boolean                     as recurring_revenue
        , impacted_by_financial_markets::varchar(200)    as impacted_by_financial_markets
        , coa_segment_1_legal_entity_id::varchar(200)    as coa_segment_1_legal_entity_id
        , coa_segment_2_product_id::varchar(200)         as coa_segment_2_product_id
        , coa_segment_3_accounting_id::varchar(200)      as coa_segment_3_accounting_id
        , coa_segment_4_team_id::varchar(200)            as coa_segment_4_team_id
        , coa_segment_5_natural_account_id::varchar(200) as coa_segment_5_natural_account_id
        , coa_segment_6_initiative_id::varchar(200)      as coa_segment_6_initiative_id
        , coa_segment_7_intercompany_id::varchar(200)    as coa_segment_7_intercompany_id
        , coa_segment_8_future_id::varchar(200)          as coa_segment_8_future_id
        , coa_account_number::varchar(1607)              as coa_account_number
        , revenue_category::varchar(200)                 as revenue_category
        , revenue_type::varchar(600)                     as revenue_type
        , system_name_crm::varchar(200)                  as system_name_crm
        , system_instance_crm::varchar(200)              as system_instance_crm
        , system_key_crm::varchar(200)                   as system_key_crm
        , account_id_crm::varchar(200)                   as account_id_crm
        , client_id_crm::varchar(200)                    as client_id_crm
        , client_id_original_crm::varchar(200)           as client_id_original_crm
        , client_id_unique_compass::varchar(200)         as client_id_unique_compass
        , client_name::varchar(200)                      as client_name
        , client_name_original_crm::varchar(200)         as client_name_original_crm
        , client_lead_source::varchar(600)               as client_lead_source
        , client_key_tags_crm::varchar(15000)            as client_key_tags_crm
        , transaction_type::varchar(600)                 as transaction_type
        , transaction_line_type::varchar(600)            as transaction_line_type
        , transaction_line_quantity::number(20 , 5)      as transaction_line_quantity
        , currency_code::varchar(200)                    as currency_code
        , currency_conversion_type::varchar(200)         as currency_conversion_type
        , unit_selling_price::number(20 , 5)             as unit_selling_price
        , excluded_reasons::varchar(2000)                as excluded_reasons
        , is_excluded::number(38 , 0)                    as is_excluded
        , _invoice_key::varchar(200)                     as _invoice_key
