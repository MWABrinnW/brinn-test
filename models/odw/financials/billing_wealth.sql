...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_addepar_corbenic_compass') }}
...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_addepar_corbenic_practifi') }}
...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_black_diamond_houston') }}
...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_black_diamond_uhnw') }}
...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_sei_manasquan') }}
...
select
    {{ columns }}
    , 0::int as is_legacy
from {{ ref('bld_billing_wealth_envestnet_manasquan') }}
