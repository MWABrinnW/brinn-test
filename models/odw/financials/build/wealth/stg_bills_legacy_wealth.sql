...
select
    ...
    , office_name::varchar(300)                   as office_name
    ...
    , null::varchar(200)                          as model_investment_strategy
    , null::varchar(200)                          as custodian
    ...
    , null::varchar(600)                          as fee_schedule_source
...
from reporting.ext.revenue_billing_legacy
