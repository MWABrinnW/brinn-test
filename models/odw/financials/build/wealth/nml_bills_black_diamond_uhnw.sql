...
select
    ...
    , dateadd('day' , -1 , date_trunc('month' , bb.cash_available_date))::date as assets_as_of_date
    , dateadd('day' , -1 , date_trunc('month' , bb.cash_available_date))::date as fee_calculation_date
