select
    ...
    , ir.orion_account_id_c::text(200)                                as account_id_pms
    , ir.registration_name_c::text(200)                               as registrant_name
    , coalesce(acc.account_name , acc2.account_name)::text(200)       as account_name
    , coalesce(
        ir.account_type_c
    ...
    , ir.estate_item_c::text(200)                                     as account_id_crm
    , coalesce(
        ir.company_family_c
        , acc.household_id
        , acc2.household_id
    )::text(200)                                                      as client_id_crm
    ...
    )::text(200)                                                      as client_id_unique_compass
    , coalesce(
    ...
    ,ir.branch_2_c::text(200) as branch_secondary
    ,ir.collection_date_c::date as collection_date
    ,ir.quarterback_2_c::text(200) as quarterback_secondary
