...
select
    -- [system attributes]
    nml.system_name::text(200)                                                        as system_name
    , nml.system_instance::text(200)                                                  as system_instance
    , nml.system_key::text(200)                                                       as system_key
    , nml.firm_source::text(200)                                                      as firm_source
    ...
    end::text(200)                                                                    as location_code
    , case
        when nml.advisor_nonadvisor ilike 'Advisor'
            then loc_adv.office_name
        else nml.client_office_name
    end::text(200)                                                                    as office_name
    , nml.client_location_code::text(200)                                             as client_location_code
    , nml.client_office_name::text(200)                                               as client_office_name
    ...
    -- [invoice]
    , nml.invoice_number_source::text(200)                                            as invoice_number_source
    , nml.billing_statement_id_source::text(200)                                      as billing_statement_id_source
    , nml.billing_statement_id_crm::text(200)                                         as billing_statement_id_crm
    , initcap(nml.invoice_status::text(200))                                          as invoice_status
    , nml.is_intra_period_invoice::int                                                as is_intra_period_invoice
    , nml.account_number::text(200)                                                   as account_number
    , nml.account_number_formatted::text(200)                                         as account_number_formatted
    , nml.billing_account_number::text(200)                                           as billing_account_number
    , nml.account_id_pms::text(200)                                                   as account_id_pms
    , nml.registrant_name::text(200)                                                  as registrant_name
    , nml.account_name::text(200)                                                     as account_name
    , nml.type_of_account::text(200)                                                  as type_of_account
    , nml.client_id_pms::text(200)                                                    as client_id_pms
    , nml.aum_classification_status::text(200)                                        as aum_classification_status
    , nml.model_investment_strategy::text(200)                                        as model_investment_strategy
    , nml.model_grouping_assignment::text(200)                                        as model_grouping_assignment
    , nml.custodian::text(200)                                                        as custodian
    , nml.billing_custodian::text(200)                                                as billing_custodian
    , nml.partner_firm::text(200)                                                     as partner_firm
    ...
    -- [assets and fees]
    , initcap(nml.fee_type::text(200))                                                as fee_type
    , initcap(nml.fee_schedule_source::text(200))                                     as fee_schedule_source
    , initcap(nml.fee_schedule_type::text(200))                                       as fee_schedule_type
    , initcap(nml.fee_schedule::text(200))                                            as fee_schedule
    ...
    , initcap(nml.billing_style::text(200))                                           as billing_style
    , initcap(nml.billing_frequency::text(200))                                       as billing_frequency
    , initcap(nml.billing_method::text(200))                                          as billing_method
    , initcap(nml.bill_on_balance_type::text(200))                                    as bill_on_balance_type
    , initcap(nml.payment_terms::text(200))                                           as payment_terms
    , initcap(nml.payment_method_fee::number(20 , 5))                                 as payment_method_fee

    -- [accounting]
    , lower(nml.account_class::text(200))                                             as account_class
    ...
    )::text(200)                                                                      as coa_segment_1_legal_entity_id
    , '000'::text(200)                                                                as coa_segment_2_product_id
    , nml._coa_segment_3_accounting_id                                                as coa_segment_3_accounting_id
    , nml.associate_coa_segment_4::text(200)                                          as coa_segment_4_team_id
    , coalesce(nml.coa_segment_5_natural_account_id , null)::text(200)                as coa_segment_5_natural_account_id
    , '000'::text(200)                                                                as coa_segment_6_initiative_id
    , '000'::text(200)                                                                as coa_segment_7_intercompany_id
    , '000'::text(200)                                                                as coa_segment_8_future_id
    , concat_ws(
        '-'
    ...
    , nml.revenue_category::text(200)                                                 as revenue_category
    , initcap(nml.revenue_type::text(200))                                            as revenue_type

    -- [crm]
    , nml.system_name_crm::text(200)                                                  as system_name_crm
    , nml.system_instance_crm::text(200)                                              as system_instance_crm
    , nml.system_key_crm::text(200)                                                   as system_key_crm
    , nml.account_id_crm::text(200)                                                   as account_id_crm
    , nml.client_id_crm::text(200)                                                    as client_id_crm
    , nml.client_id_original_crm::text(200)                                           as client_id_original_crm
    , nml.client_id_unique_compass::text(200)                                         as client_id_unique_compass
    , nml.client_name::text(200)                                                      as client_name
    , nml.client_name_original_crm::text(200)                                         as client_name_original_crm
    , initcap(nml.client_lead_source::text(200))                                      as client_lead_source
    , initcap(nml.client_key_tags_crm::text(5000))                                    as client_key_tags_crm

    -- [transactions]
    , initcap(nml.transaction_type::text(200))                                        as transaction_type
    , initcap(nml.transaction_line_type::text(200))                                   as transaction_line_type
    , nml.transaction_line_quantity::number(20 , 5)                                   as transaction_line_quantity
    , nml.currency_code::text(200)                                                    as currency_code
    , nml.currency_conversion_type::text(200)                                         as currency_conversion_type
    , nml.unit_selling_price::number(20 , 5)                                          as unit_selling_price

    -- [exclusion]
    , nml.excluded_reasons::text(2000)                                                as excluded_reasons
    ...
    )::text(200)                                                                      as _invoice_key
    , nml._source_loaded_at::datetime                                                 as _source_loaded_at
    , nml._source_file::text(200)                                                     as _source_file
    , nml._box_file_id::text(200)                                                     as _box_file_id
