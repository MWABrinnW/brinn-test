...
, cte_coa_seg_3 as (
    ...
    from {{ ref('int_billing_wealth_01_union') }} as nml
)
...
select
    ...
    , nml.client_location_code::varchar(200)
    ...
    , nml.revenue_period_end_date::date
        as revenue_period_end_date
    , dateadd(day , -1 , dateadd('Quarter' , 1 , date_trunc('Quarter' , nml.revenue_period_end_date)))::date
        as revenue_quarter_end_date

    -- [invoice]
    , nml.invoice_number_source::varchar(200)
    ...
    , nml.billing_account_number::varchar(200)
    ...
    , nml.partner_firm_original::varchar(200)
        as partner_firm_original

    -- [advisor]
    , nml.client_manager_source::varchar(200)
        as client_manager_source
    , nml.client_manager_original::varchar(200)
        as client_manager_original
    , nml.associate_id_original::varchar(200)
        as associate_id_original
    , nml.client_manager_primary::varchar(200)
        as client_manager_primary
    , nml.associate_id_primary::varchar(200)
        as associate_id_primary
    , nml.client_manager_type::varchar(200)
        as client_manager_type
    ...
    , initcap(nml.fee_schedule_source::varchar(200))
    ...
    , nml.fee_calculation_date::date
        as fee_calculation_date
    , case
    ...
    , nml.total_account_value::number(20 , 5)
        as total_account_value
    , nml.billable_value::number(20 , 5)                                                                     as billable_value
    , nml.fee_excluded_assets::number(20 , 5)
        as fee_excluded_assets
    ...
    , nml.client_adjustments_fee::number(20 , 5)
        as client_adjustments_fee
    , nml.client_write_off_fee::number(20 , 5)
        as client_write_off_fee
    ...
    , initcap(nml.bill_on_balance_type::varchar(200))
        as bill_on_balance_type
    ...
    , nml._coa_segment_3_accounting_id
        as coa_segment_3_accounting_id
    , nml.associate_coa_segment_4::varchar(200)
    ...
    , nml.system_instance_crm::varchar(200)
    ...
    , nml.client_id_original_crm::varchar(200)
    ...
    , initcap(nml.client_key_tags_crm::varchar(5000))
        as client_key_tags_crm

    -- [transactions]
    , initcap(nml.transaction_type::varchar(200))                                                            as transaction_type
    , initcap(nml.transaction_line_type::varchar(200))
