...
select
    ...
    , replace(ltrim(bb.account_number , '0') , '-' , '')::text(200)              as account_number
    ...
    end::text(200)                                                               as billing_account_number
    , bb.external_id::text(200)                                                  as account_id_pms
    , bb.account_long_name::text(200)                                            as registrant_name
    , bb.account_name::text(200)                                                 as account_name
    , ba.account_registration_type::text(200)                                    as type_of_account
    , br.rel_id::text(200)                                                       as client_id_pms
    , case
    ...
    end::text(200)                                                               as aum_classification_status
    , bm.benchmark_name::text(200)                                               as model_investment_strategy
    , bb.custodian::text(200)                                                    as custodian
    , coalesce(bb.billing_account_custodian , bb.custodian)::text(200)           as billing_custodian
    , null::text(200)                                                            as partner_firm
    , null::text(200)                                                            as partner_firm_original

    -- [advisor]
    , coalesce(ba.team , bb.team)::text(200)                                     as advisor_source
    ...
    , sf.fee_schedule_type::text(200)                                            as fee_schedule_type
    , bb.fee_schedule_name::text(200)                                            as fee_schedule
    ...
    , '190'::text(200)                                                           as coa_segment_1_legal_entity_id
    , '6609'::text(200)                                                          as coa_segment_3_accounting_id
    , null::text(200)                                                            as coa_segment_4_team_id
    , '40001'::text(200)                                                         as coa_segment_5_natural_account_id
    -- sourced from "aux__stg_financials_fee_type" if not hardcoded
    ...
    , 'adviceperiod'::text(200)                                                  as system_instance_crm
    , sf.system_key::text(200)                                                   as system_key_crm
    , sf.id::text(200)                                                           as account_id_crm
    , sf.owner_id::text(200)                                                     as client_id_crm
    , sf.owner_id::text(200)                                                     as client_id_original_crm
    , null::text(200)                                                            as client_id_unique_compass
    , sf.name::text(200)                                                         as client_name
    , sf.name::text(200)                                                         as client_name_original_crm
    , null::text(200)                                                            as client_lead_source
    , null::text(5000)                                                           as client_key_tags_crm

    -- [transactions]
    , null::text(200)                                                            as transaction_type
    , null::text(200)                                                            as transaction_line_type
    ...
    , object_construct_keep_null(
        'join_pms_mps_base_accts_is_head' , iff(ba.id is not null , 1 , 0)
        , 'join_crm_sal_eff_date' , iff(sf.salentica_lmnts_custodian_account_number is not null , 1 , 0)
        , 'join_pms_mps_base_relat_eff_date' , iff(br.account_id is not null , 1 , 0)
        , 'join_pms_mps_base_bench_is_head' , iff(bm.account_number is not null , 1 , 0)
