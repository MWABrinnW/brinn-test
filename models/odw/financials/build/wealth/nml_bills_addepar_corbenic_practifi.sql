...
select
    ...
    , a.cwm_strategy::text(200)                                               as model_investment_strategy
    , b.cwm_custodian::text(200)                                              as custodian
    ...
    , a.fee_schedule_legacy::text(200)                                        as fee_schedule_source
    ...
    -- [crm]
    , c.system_name::text(200)                                                as system_name_crm
    , c.system_instance::text(200)                                            as system_instance_crm
    , c.system_key::text(200)                                                 as system_key_crm
    , c.pract_asset_liability_id::text(200)                                   as account_id_crm
    , c.pract_hh_id::text(200)                                                as client_id_crm
    , null::text(200)                                                         as client_id_original_crm
    , null::text(200)                                                         as client_id_unique_compass
    , c.pract_hh_name::text(200)                                              as client_name
    , c.pract_hh_name::text(200)                                              as client_name_original_crm
