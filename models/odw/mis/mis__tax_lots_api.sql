...
, orion_assets as (
    ...
    from {{ ref('mis__stg_orion_tax_lots') }} as t
    where 1 = 1
...
{# , orion_products as (
    select
        ...
        , prod.ticker
        , prod.cusip
        , prod.is_custodial_cash
        , prod.product_name
        , prod.product_type
        , prod.product_category
        , prod.asset_class
        , prod.is_product_managed
    from orion_assets as prod
    where 1 = 1
    group by all
...
, redshift_format as (
    select
        ...
        --, upper(a.acctcode)                                                   as account_number_formatted
