select
    ...
    -- appropriately.
    , (
        a.current_price / coalesce(a.factor::decimal(20 , 12) , 1)
    ...
    , (
        ...
        * (
            a.current_price::decimal(20 , 5) / coalesce(a.factor::decimal(20 , 12) , 1)
        )::decimal(20 , 9)
