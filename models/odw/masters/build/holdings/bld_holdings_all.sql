-- Holdings from PMS, legacy, and manual load.
select
    ...
    , bh.account_id::text(500)    as account_id
    ...
    , bh.is_manual_holdings       as is_manual_holdings
    , bh.is_legacy                as is_legacy
...
-- We use orion holdings separately because we are frequently allowing it to backfill
-- which constantly changes the _created_at value and would trigger many days to
-- rebuild.
select
    ...
    , obh.account_id::text(500)    as account_id
