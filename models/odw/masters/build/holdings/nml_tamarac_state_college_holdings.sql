...
{%-
    set src_models = [
          'tamarac_state_college_history__base_holdings'
    ]
-%}
...
select
    ...
    --- [account + holdings] ---------------------------------------------------------
    , upload_account_id::text(500)           as account_id
