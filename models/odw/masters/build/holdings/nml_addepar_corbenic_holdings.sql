...
{%-
    set src_models = [
          'addepar_corbenic_history__base_holdings'
    ]
-%}
...
select
    ...
    , top_level_holding_account_entity_id::text(500) as account_id
    ...
    , cwm_custodian::text(500)                       as custodian
    , cusip::text(500)                               as cusip
    , ticker_symbol::text(500)                       as ticker
    , null::int                                      as is_ticker_cusip
    , null::int                                      as is_custodial_cash
    , security_entity_id::text(500)                  as security_id
    , security::text(500)                            as security_name
    , actual_security_type::text(500)                as security_type
    , null::text(500)                                as security_subtype
    , cwm_asset_class::text(500)                     as asset_class
