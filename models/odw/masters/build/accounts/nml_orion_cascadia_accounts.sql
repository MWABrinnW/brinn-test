select
    ...
    || coalesce(case
        when pms_account_name ilike 'Hist Account'
            then 'Historical account;'
    end , '')
    || coalesce(case
        when pms_advisor = 'Demo Rep'
            then 'Demo rep;'
    end , '')
    || coalesce(case
        when 1 = 2--noqa:ST10
...
where true
    ...
    and a.system_key = 'orion__cascadia'
    -- Exclude after integration with orion__core
    and a.effective_date <= '2024-08-30'
