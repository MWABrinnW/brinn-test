select
    'insurance'::text                                          as system_name
    , 'mir'::text                                              as system_instance
    , concat(system_name , '__' , system_instance)::text       as system_key
    ...
    , nullif(trim((json:"Client Manager 1")::text) , '')::text as client_manager_1
    , nullif(trim(json:"Client Manager 2") , '')::text         as client_manager_2
    , nullif(trim(json:"Introducer 1") , '')::text             as introducer_1
    , nullif(trim(json:"Introducer 2") , '')::text             as introducer_2
