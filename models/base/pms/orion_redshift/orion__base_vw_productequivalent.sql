select
    ...
    , a.content:pkproductequivalent::integer as pkproductequivalent
    , a.content:fkentity::integer            as fkentity
    , a.content:entityenum::integer          as entityenum
    , a.content:fkproductmodel::integer      as fkproductmodel
    ...
    , {{ col_is_head(reference=source('orion', 'vw_productequivalent'),
...
from {{ source('orion', 'vw_productequivalent') }} as a
