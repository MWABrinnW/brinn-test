select
    ...
    , a.content:fkhousehold::integer         as fkhousehold
    ...
    , {{ col_is_head(reference=source('orion', 'vw_userdefinedfields_household'),
...
from {{ source('orion', 'vw_userdefinedfields_household') }} as a
