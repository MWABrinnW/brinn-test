select
    ...
    , a.content:pricedate::date            as pricedate
    , a.content:fkcustodiancommon::integer as fkcustodiancommon
    , a.content:pricesource::integer       as pricesource
    , a.content:navprice::double precision as navprice
    , a.content:isvalidated::boolean::int  as isvalidated
    , a.content:createddate::timestamp     as createddate
    , a.effective_at::date                 as effective_date
    , a._pk::varchar(200)                  as _pk

    , a._extracted_at::timestamp_ntz       as _extracted_at
    , {{ col_is_head(reference=source('orion', 'vw_price'),
...
from {{ source('orion', 'vw_price') }} as a
