select
    ...
    , closed_account                               as closed_account
    ...
    , advisor_description                          as advisor_description
    , advisor_name                                 as advisor_name
    , billing_spec                                 as billing_spec
    ...
    , {{ col_is_head(
        reference=source('portfoliocenter_tcea', 'fa_accounts_history')
        ) }}
