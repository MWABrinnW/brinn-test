select
    ...
    , json:MASTER_LABEL::varchar(765)                         as master_label
    , json:API_NAME::varchar(765)                             as api_name
    , json:IS_ACTIVE::boolean                                 as is_active
    , json:SORT_ORDER::number                                 as sort_order
    ...
    , json:DEFAULT_PROBABILITY::double                        as default_probability
