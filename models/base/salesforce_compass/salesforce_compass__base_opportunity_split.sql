select
    ...
    , json:SPLIT::varchar(765)                                as split
    ...
    , json:SPLIT_OWNER_ID::varchar(18)                        as split_owner_id
    , json:SPLIT_PERCENTAGE::double                           as split_percentage
    , json:SPLIT_NOTE::varchar(765)                           as split_note
    , json:SPLIT_TYPE_ID::varchar(18)                         as split_type_id
    , json:SPLIT_AMOUNT::number(18 , 2)                       as split_amount
    ...
    , {{ col_is_head(
    reference=source('salesforce_compass', 'opportunity_split')
