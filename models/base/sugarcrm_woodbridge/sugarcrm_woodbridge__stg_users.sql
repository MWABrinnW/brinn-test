{% set src = source('sugarcrm_woodbridge', 'users') %}

select
    json:"ACL_ROLE_SET_ID"::text                                                 as acl_role_setid
    , json:"AUTHENTICATE_ID"::text                                               as authenticate_id
    ...
    , try_to_boolean(json:"CUSTOM_U_CALCULATEDFIELDS_APP_NOTIFY_C"::text)::int   as custom_u_calculated_fields_app_notify_c
    , try_to_boolean(json:"CUSTOM_U_CALCULATEDFIELDS_EMAIL_NOTIFY_C"::text)::int as custom_u_calculated_fields_email_notify_c
    , try_to_boolean(json:"CUSTOM_U_CUSTOM_APP_NOTIFY_C"::text)::int             as custom_u_custom_app_notify_c
    , try_to_boolean(json:"CUSTOM_U_CUSTOM_EMAIL_NOTIFY_C"::text)::int           as custom_u_custom_email_notify_c
    , try_to_boolean(json:"CUSTOM_U_DEDUPLICATE_APP_NOTIFY_C"::text)::int        as custom_u_deduplicate_app_notify_c
    , try_to_boolean(json:"CUSTOM_U_DEDUPLICATE_EMAIL_NOTIFY_C"::text)::int      as custom_u_deduplicate_email_notify_c
    ...
    , try_to_boolean(json:"HASH"::text)::int                                     as hash
    , json:"ID"::text                                                            as id
    ...
    , json:"SITE_USER_ID"::text                                                  as site_userid
    , json:"STATUS"::text                                                        as status
    , try_to_boolean(json:"SUGAR_LOGIN"::text)::int                              as sugar_login
    , json:"SYNC_KEY"::text                                                      as sync_key
    , try_to_boolean(json:"SYSTEM_GENERATED_PASSWORD"::text)::int                as system_generated_password
    ...
    , json:"authorized_account"::text                                            as authorized_account
    , json:"eapm_id"::text                                                       as eapm_id
    , json:"mail_authtype"::text                                                 as mail_authtype
    , json:"mail_smtpserver"::text                                               as mail_smtp_server
    , json:"mail_smtptype"::text                                                 as mail_smtp_type
    , json:"mail_smtpuser"::text                                                 as mail_smtp_user
