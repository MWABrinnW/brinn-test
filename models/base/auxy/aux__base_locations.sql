select
  ...
  , json:division::varchar(100)                  as division
  , json:legal_name::varchar(100)                as legal_name
  , json:region_name::varchar(100)               as region_name
  , json:market_name::varchar(100)               as market_name
  , json:location_name::varchar(100)             as location_name
  , json:office_name::varchar(100)               as office_name
  , json:location_city::varchar(100)             as location_city
  , json:location_state::varchar(50)             as location_state
  , json:accounting_id::varchar(25)              as accounting_id
  , json:accounting_id_description::varchar(200) as accounting_id_description
  , json:acquisition_name::varchar(100)          as acquisition_name
  , json:acquisition_type::varchar(100)          as acquisition_type
