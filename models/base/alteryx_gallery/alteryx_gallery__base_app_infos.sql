select
  ...
  , ai.json:PublishedRevision:Applications[0]:MetaInfo:Author::varchar(100)      as author
  , ai.json:PublishedRevision:Applications[0]:MetaInfo:Name::varchar(100)        as name
  , ai.json:PublishedRevision:Applications[0]:MetaInfo:Description::varchar(500) as description
  , ai.json:CreatedBy::string                                                    as created_by
...
from {{ source('alteryx_gallery', 'appinfos') }} ai