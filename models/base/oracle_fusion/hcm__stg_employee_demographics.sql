select
    ...
    , nullif(trim(split(content , '|')[22]) , '')::date         as associate_birth_date
    ...
    , nullif(trim(split(content , '|')[46]) , '')::date         as associate_original_hire_date
    , nullif(trim(split(content , '|')[47]) , '')::date         as associate_rehire_date
    , nullif(trim(split(content , '|')[48]) , '')::date         as associate_final_termination_date
    , nullif(trim(split(content , '|')[49]) , '')::date         as position_seniority_hire_date
    , nullif(trim(split(content , '|')[50]) , '')::date         as position_start_date
