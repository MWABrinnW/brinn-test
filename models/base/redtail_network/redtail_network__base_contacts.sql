select
    ...
    , json:first_name::varchar(200)         as first_name--noqa: RF04
    , json:middle_name::varchar(200)        as middle_name--noqa: RF04
    , json:last_name::varchar(200)          as last_name--noqa: RF04
    ...
    , json:added_by_name::varchar(200)      as added_by_name
    ...
    , {{ col_is_head(reference=source('redtail_network', 'contacts'),
