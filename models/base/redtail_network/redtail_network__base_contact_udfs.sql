select
    ...
    , json:contact_udf_field_name::text as contact_udf_field_name
    , json:field_type::int              as field_type
    , json:field_type_description::text as field_type_description
    , json:field_value::text            as field_value
