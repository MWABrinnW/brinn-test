select
  ...
  , a.json:PREFERENCES_VISIBLE_IN_CSP::boolean            as preferences_visible_in_csp
  , a.json:ACCESS_LEVEL::text(1000)                       as access_level
