select r.json:"H2 H3"::varchar(100)                                       as h2_h3
     ...
     , try_to_date(to_char(r.json:"Last Update"), 'YYYYMMDD')::date       as last_update
     , r.json:"S F"::varchar(100)                                         as s_f
     , r.json:"Closing Price"::decimal(16, 5)                            as closing_price
     , try_to_date(to_char(r.json:"SecPrice LstUpDte"), 'YYYYMMDD')::date as secprice_lstupdte
     , r.json:"Security Valuation Unit"::decimal(15, 5)                   as security_valuation_unit
     , r.json:"OptnRt Symbol"::varchar(100)                               as optnrt_symbol
     , try_to_date(to_char(r.json:"Opt Expr Date"), 'YYYYMMDD')::date     as opt_expr_date
     , r.json:"C P"::varchar(100)                                         as c_p
     ...
     , r.json:"Face Value Amt"::decimal(13, 4)                           as face_value_amt
     , r.json:"St Cd"::varchar(100)                                       as st_cd
     , r.json:"VersMrkr #1"::varchar(100)                                 as versmrkr_1
     , r.json:"P I"::varchar(100)                                         as p_i
     , r.json:"O I"::varchar(100)                                         as o_i
