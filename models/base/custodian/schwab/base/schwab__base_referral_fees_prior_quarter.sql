...
select
  ...
  , case
        ...
        else trim(substring(content, 121, 12)) end::decimal(14, 2) as account_daily_balance
  , case
  ...
  , case
        ...
        else trim(substring(content, 150, 12)) end::decimal(14, 2) as household_ave_billable_assets
  , case
  ...
  , case
        ...
        else trim(substring(content, 169, 12)) end::decimal(14, 2) as fees_due_for_household
