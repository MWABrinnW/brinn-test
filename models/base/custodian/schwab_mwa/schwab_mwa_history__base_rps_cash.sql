select r.json:"H4 H5"::varchar(100)                             as h4_h5
     ...
     , r.json:"MstrAcct Number"::varchar(100)                   as mstracct_number
     ...
     , r.json:"Acct Regis"::varchar(100)                        as account_regis
     ...
     , r.json:"MTD Margin Int"::decimal(15, 2)                  as mtd_margin_int
     , r.json:"Daily Margin Int"::decimal(15, 2)                as daily_margin_int
     , r.json:"Eqty Excl Option"::decimal(15, 2)                as equity_excl_option
     ...
     , r.json:"Eqty Incl Option"::decimal(15, 2)                as equity_incl_option
     , r.json:"Option Rqrmnts"::decimal(15, 2)                  as option_requirements
     , r.json:"Mnth End Div Pay"::decimal(15, 2)                as month_end_div_pay
     , r.json:"Maintenance Call"::decimal(15, 2)                as maintenance_call
     , r.json:"MVL Cash Ex Optn"::decimal(15, 2)                as mvl_cash_ex_option
     , r.json:"Net MV Positions"::decimal(15, 2)                as net_mv_positions
     , r.json:"Net MV Plus Cash"::decimal(15, 2)                as net_mv_plus_cash
     ...
     , r.json:"Bank Sweep IBF"::decimal(15, 2)                  as bank_sweep_ibf
     , {{ col_is_head(reference=source('schwab_mwa', 'accounts')) }}
     , {{ col_is_current(date_col='effective_date') }}
     , 'mwa'                                                    as firm_source
     , effective_date::date                                     as effective_date
     , _created_at::timestamp                                 as record_datetime
     , _created_at::timestamp                                 as _source_loaded_at
from {{ source('schwab_mwa', 'rps_d2') }} r
